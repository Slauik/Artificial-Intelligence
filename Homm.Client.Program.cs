    ...
    class Program
    {
        ...
        private static void Connect(string[] args)
        {
            ...
            sensorData = client.Configurate(
              ...
              operationalTimeLimit: 10000,   // Суммарное время в секундах, которое разрешается "думать" вашей программе. 
              ...
              seed: 4,                    // Seed карты. Используйте этот параметр, чтобы получать одну и ту же карту и отлаживаться на ней.
